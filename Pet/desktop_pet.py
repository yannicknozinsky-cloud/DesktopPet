...
DB_PATH = "/home/yannick/Projekts/Desktop_Pet/Desktop_pet.db"
...
class DesktopPet(QtWidgets.QLabel):
    ...
    def __init__(self):
        ...
        self.original_pixmap = QtGui.QPixmap(
            "/home/yannick/Projekts/Desktop_Pet/blue_black_boy/"+self.colour+"_shime1-1.png.png"
        ).scaled(
            self.pet_width,
            self.pet_height,
    ...
    def new_frame(self, url:str): 
        self.original_pixmap = QtGui.QPixmap("/home/yannick/Projekts/Desktop_Pet/blue_black_boy/"+self.colour+url).scaled(
            self.pet_width,
            self.pet_height,
            QtCore.Qt.KeepAspectRatio,
            QtCore.Qt.SmoothTransformation
    ...
    def update_frame(self):
        self.original_pixmap = QtGui.QPixmap("/home/yannick/Projekts/Desktop_Pet/blue_black_boy/"+self.colour+self.current_path).scaled(
            self.pet_width,
            self.pet_height,
            QtCore.Qt.KeepAspectRatio,
            QtCore.Qt.SmoothTransformation
